...
*
* This is the header file for the template class Vector
* which represents Vectors. 
* This file also contains the implementation of the 
* methods of the class.
* 
* This file is taken directly from the course booklet
* as stated to do in the assignment.
*
*/
